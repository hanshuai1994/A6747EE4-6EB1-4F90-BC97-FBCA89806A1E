...
const loadModel = (path, builds_map, systems_map, length, index) => {
...
// 
const analysisFBX = (paths, builds_map, systems_map, callback) => {
    ...
    for (let i = 0; i < length; i++) {
        ...
        promise = promise.then(function () {
            return loadModel(path, builds_map, systems_map, length, i);
        })
